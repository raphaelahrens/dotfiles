...
local exitmenu = {
   { "Shutdown", "/home/tant/bin/opBox-exit.sh halt" },
   { "Reboot", "/home/tant/bin/opBox-exit.sh reboot" },
...
local globalkeys = gears.table.join(
    ...
    awful.key({ modkey,}, "Tab", function () awful.client.cycle(false) end,
              {description = "cycle forward", group = "client"}),
    awful.key({ modkey, "Shift" }, "Tab", function () awful.client.cycle(true) end,
...
--              {description = "open a terminal", group = "launcher"}),
    ...
    awful.key({ modkey, }, "c",
              rc_lib.run_raise_as_master(tty, {class = tty_class}),
              {description = "start or raise terminal", group = "awesome"}
             ),
    awful.key({ modkey, }, "v",
...
local clientkeys = gears.table.join(
    ...
    awful.key({modkey}, "Return",
                ...
                {
                    description = "make window to master",
                    group = "client"
                }),
    awful.key({modkey,}, "o",
